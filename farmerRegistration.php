<?php
	...
	if(isset($_REQUEST['submit']))
	{
		...
		$pin = $_REQUEST['pin'];
		$qry = "INSERT INTO farmer(fname, fcontact, femail, fpassword, fcity, fdistrict, state, fstreetname, fpincode, fblock, farea) VALUES ('$fname','$contact','$email','$password','$city','$district','$state','$street','$pin','$block','$area')";
      ...
      <div class="bg-color">
        <div class="container">
          <div class="row">
              ...
              <h1 style="text-align: center; margin-bottom: -30px;font-size: 50px;letter-spacing: 3px;    margin-top: 10%;color: #f1ebcf;">Farmer Registration</h1>
...
<div class="container">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <form method="post" action="farmerRegistration.php" enctype="multipart/form-data">
