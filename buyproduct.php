                 ...
                 <form method="POST">
                    <div class="row">
                      ...
                      ?>
                         ...
                         <input type="text" id="one" name="product">
      ...
      <div class="col-md-3 col-sm-3 xol-xs-3" id="a">
        <ul class="nav navbar-stacked">
			...
			<script>
			 ...
			 <li style="padding-left: 20px;color: white"><h4 style="color: white">Types Of goods</h4></li>
             &nbsp;&nbsp;&nbsp;<input type="radio" id="gtype1" name="gtype" value="perish"> Perishable goods<br>
   
            &nbsp;&nbsp;&nbsp;<input type="radio"  id="gtype2" name="gtype" value="non">Non-perishable goods<br><br><br>
					...
					$("#gtype1").focus(function(e)
                     {
                        ...
                        $.ajax({
                                  type: "POST",
                                  data:{city:city,product:product,wtype:value,htl:htl,wtype:bond,gtype:value},
                                  url:"search.php",
                                  success: function(data)
                                  {
                                      $("#abc").html(data);
